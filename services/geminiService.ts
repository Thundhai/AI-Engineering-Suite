...
import { EngineeringOutput, GenerationMode, UploadedFile, ChatMessage } from '../types';
...
export async function generateEngineeringOutput(prompt: string, activeAgents: string[], mode: GenerationMode, files: UploadedFile[], isRedactionEnabled: boolean): Promise<EngineeringOutput> {
